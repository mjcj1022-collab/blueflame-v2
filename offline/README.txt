...
SIGNING IN
----------
Offline copies use a simple local sign-in (no account needed, nothing sent
anywhere). Ask whoever set this up for your username and password.

YOUR DESIGNS
------------
Everything you make is saved automatically in this browser, on this
computer. To back up your work, use the export tools inside the app (STL,
STEP, PDF, etc.) — copy those files somewhere safe periodically.

QUESTIONS OR ISSUES
--------------------
Contact the shop you purchased this from.
